...
{
    public partial class payments_transaction : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                // SQL command to fetch data from the 'AccountPayments' view
                ...
                // Bind the data table to the GridView for displaying the payment transaction details
                GridViewAccountPayments.DataSource = dt;
                GridViewAccountPayments.DataBind();
            }
            catch (Exception ex)
            {
