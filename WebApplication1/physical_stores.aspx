<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="physical_stores.aspx.cs" Inherits="WebApplication1.physical_stores" %>
...
<div class="sidebar-line"></div>
    ...
    Physical Stores
        ...
        <asp:GridView ID="GridViewPhysicalStores" runat="server" CssClass="custom-gridview">
        </asp:GridView>
    </form>
</body>
</html>
