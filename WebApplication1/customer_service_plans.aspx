<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customer_service_plans.aspx.cs" Inherits="WebApplication1.customer_service_plans" %>
...
<div class="sidebar-line"></div>
    ...
    <!-- Dynamic Headline -->
     ...
     Customer Service Plans
        ...
        <asp:GridView ID="GridViewCustomerServicePlans" runat="server" CssClass="custom-gridview">
        </asp:GridView>
    </form>
</body>
</html>
