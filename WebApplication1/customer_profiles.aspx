<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customer_profiles.aspx.cs" Inherits="WebApplication1.customer_profiles" %>
...
<body>
    ...
    <div class="sidebar-line"></div>
        ...
        <!-- Table -->
        <asp:GridView ID="GridViewCustomerProfiles" runat="server" CssClass="custom-gridview" />
    </form>
</body>
</html>
