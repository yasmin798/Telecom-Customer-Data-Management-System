<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="update_points.aspx.cs" Inherits="WebApplication1.update_points" %>
...
<div class="sidebar-line"></div>
    ...
    Update Points
        ...
        <div class="content-body">
            ...
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" Text="Search" onClick="UpdateEarnedPoints"/>
            <br />
