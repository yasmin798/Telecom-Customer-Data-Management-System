...
<div class="sidebar-line"></div>
        <div class="container">
         <div class="container">
            <h2 class="page-title">Your Consumption:</h2>
             <div class="content-body">
            <asp:Label ID="PlanNameL" runat="server" Text="Plan Name:" ></asp:Label>
            <br />
            <asp:TextBox ID="PlanName" runat="server" placeholder="Enter plan name"></asp:TextBox>
       
        <asp:Label ID="StartDateL" runat="server" Text="Start Date:"></asp:Label>
        <br />
        <asp:TextBox ID="StartDate" runat="server" placeholder="YYYY-MM-DD"></asp:TextBox>
        <br />
        <asp:Label ID="EndDateL" runat="server" Text="End Date:"></asp:Label>
        <br />
        <asp:TextBox ID="EndDate" runat="server" placeholder="YYYY-MM-DD"></asp:TextBox>
        <br />
        <asp:Button ID="search" runat="server" OnClick="Search" Text="Search" /><br />
         </div>
        ...
        <br />
         <asp:Label ID="lblMessage" ForeColor="Red" runat="server" ></asp:Label>
              ...
              <asp:GridView ID="GridViewConsumption" AutoGenerateColumns="true" runat="server" CssClass="custom-gridview"></asp:GridView>
