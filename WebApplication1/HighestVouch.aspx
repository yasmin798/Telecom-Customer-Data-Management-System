<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HighestVouch.aspx.cs" Inherits="TestwJazz.HighestVouch" %>
...
<body>
    <div class="container">
        <h1 class="page-title">Highest Voucher</h1>
...
<div class="sidebar-line"></div>
        <div class="container">
            <div>
                ...
                <asp:Button ID="btnGetHighestVoucher" runat="server" Text="Get Highest Voucher" CssClass="button" OnClick="btnGetHighestVoucher_Click" />
                <br /><br />

                <!-- Label to display the highest voucher -->
                <asp:Label ID="lblHighestVoucher" runat="server" Font-Bold="True" ForeColor="Green" />
