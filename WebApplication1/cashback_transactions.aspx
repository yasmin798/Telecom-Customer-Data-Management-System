<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cashback_transactions.aspx.cs" Inherits="WebApplication1.cashback_transactions" %>
...
<div class="sidebar-line"></div>
    ...
    <div class="page-title" id="PageTitle">
        ...
        <asp:GridView ID="GridViewCashbackTransactions" runat="server" cssClass="custom-gridview">
        </asp:GridView>
    </form>
</body>
</html>
