<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customer_wallets.aspx.cs" Inherits="WebApplication1.customer_wallets" %>
...
<div class="sidebar-line"></div>
    ...
    Customer Wallets
        ...
        <div>
            <asp:GridView ID="GridViewCustomerWallets" runat="server" CssClass="custom-gridview">
            </asp:GridView>
        </div>
    </form>
</body>
