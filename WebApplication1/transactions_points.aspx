<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="transactions_points.aspx.cs" Inherits="WebApplication1.transactions_points" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Transactions Points</title>
    ...
    Transactions Points
     ...
     <div class="content-body">
        <div>
            ...
            <br />
            <asp:Button ID="Button1" runat="server" Text="Search" onClick ="DisplayPaymentTransactions"/>
            <br />
            <br />
            <asp:GridView ID="GridViewPaymentTransactions" runat="server" CssClass="custom-gridview">
            </asp:GridView>
