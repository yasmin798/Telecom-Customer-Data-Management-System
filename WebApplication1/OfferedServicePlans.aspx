<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfferedServicePlans.aspx.cs" Inherits="WebApplication1.OfferedServicePlans" %>
...
<div class="sidebar-line"></div>
        ...
        <div class="container">
        <div>
            <h2 class="page-title">All Offered Service Plans</h2><br />
            <p class="centered">Browse the list of service plans we currently offer:</p>
            <div class="table-container">
             <asp:GridView ID="GridViewServicePlans" runat="server" AutoGenerateColumns="true" CssClass="custom-gridview">
    </asp:GridView>
        </div>
             </div>
</div>
