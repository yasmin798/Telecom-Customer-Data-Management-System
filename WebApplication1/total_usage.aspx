<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="total_usage.aspx.cs" Inherits="WebApplication1.total_usage" %>
...
<div class="sidebar-line"></div>
    ...
    Total Usage
            ...
            <br />
            <asp:Button ID="Button1" runat="server" Text="Search" OnClick="DisplayAccountUsage" />
            <br />
            <asp:Label ID="ResultLabel" runat="server" Text=" "></asp:Label>
            <br />
            <asp:GridView ID="UsageGridView" runat="server" CssClass="custom-gridview">
            </asp:GridView>
            <br />
        </div>
        </div>
