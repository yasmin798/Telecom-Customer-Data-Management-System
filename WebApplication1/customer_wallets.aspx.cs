...
{
    public partial class customer_wallets : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                // SQL command to fetch data from the 'CustomerWallet' view
                ...
                // Bind the data table to the GridView for displaying the wallet and customer details
                GridViewCustomerWallets.DataSource = dt;
