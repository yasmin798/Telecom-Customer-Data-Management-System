<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payments_transaction.aspx.cs" Inherits="WebApplication1.payments_transaction" %>
...
<div class="sidebar-line"></div>
    ...
    Payments Transactions
        ...
        <div>
            <asp:GridView ID="GridViewAccountPayments" runat="server" CssClass="custom-gridview">
            </asp:GridView>
        </div>
    </form>
</body>
