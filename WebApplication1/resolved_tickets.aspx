<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="resolved_tickets.aspx.cs" Inherits="WebApplication1.resolved_tickets" %>
...
<div class="sidebar-line"></div>
    ...
    Resolved Tickets
        ...
        <asp:GridView ID="GridViewResolvedTickets" runat="server" CssClass="custom-gridview">
        </asp:GridView>
    </form>
</body>
</html>
