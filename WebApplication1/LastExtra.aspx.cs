...
namespace TestwJazz
{
    public partial class LastExtra : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
        }

        protected void btnGetExtraAmount_Click(object sender, EventArgs e)
        {
            ...
            {
                LoadExtraAmount(mobileNum, planName);
            }
            else
            {
        ...
        private void LoadExtraAmount(string mobileNum, string planName)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                try
                {
                    ...
                    if (result != null)
                    {
                        lblExtraAmount.Text = "Extra Amount: " + result.ToString();
                    }
                    else
                    {
                        lblExtraAmount.Text = "No extra amount found for this account and plan.";
                    }
                }
                catch (Exception ex)
                {
                    lblError.Text = "Error fetching the extra amount: " + ex.Message;
                }
            }
        }
