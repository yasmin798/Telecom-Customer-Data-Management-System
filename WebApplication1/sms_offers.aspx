<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sms_offers.aspx.cs" Inherits="WebApplication1.sms_offers" %>
    ...
    SMS Offers
        ...
        <div>
           <label>Phone Number</label>
            ...
            <br />
            <asp:Button ID="Button1" runat="server" Text="Search" OnClick ="DisplaySMSOffers" />
            <br />
            <asp:GridView ID="SMSOffersGridView" runat="server" CssClass="custom-gridview">
            </asp:GridView>
            <br />
        </div>
    </div>
