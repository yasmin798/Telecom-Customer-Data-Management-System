<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BalanceRecharge.aspx.cs" Inherits="CustomerPart3.BalanceRecharge" %>
...
<div class="sidebar-line"></div>
        <div>
            <asp:Label ID="LabelMobileNo" runat="server" Text="Enter Mobile Number:  " style="font-size: 30px; font-weight: bold; color: #007BFF; display: block; margin-bottom: 0px; padding: 5px; text-align: left; margin-left:6px"></asp:Label>
            <asp:TextBox ID="txtMobileNoRecharge" runat="server" style="width: 500px; max-width: 300px; padding: 10px; font-size: 1rem; border-radius: 5px; border: 1px solid #ccc; margin-bottom: 15px; margin-left: 10px; margin-top: 0px"></asp:TextBox>
            <br />
        </div>
        <asp:Label ID="LabelAmount" runat="server" Text="Enter amount of recharge:  " style="font-size: 30px; font-weight: bold; color: #007BFF; display: block; margin-bottom: 0px; padding: 5px; text-align: left; margin-left:6px"></asp:Label>
        ...
        <br />
        <br />
        <asp:Label ID="LabelPaymentMethod" runat="server" Text="Payment Method:  " style="font-size: 30px; font-weight: bold; color: #007BFF; display: block; margin-bottom: 0px; padding: 5px; text-align: left; margin-left:6px"></asp:Label>
        <asp:DropDownList ID="ddlPaymentMethod" runat="server" Width="125px" style="max-width: 300px; padding: 10px; font-size: 1rem; border-radius: 5px; border: 1px solid #ccc; margin-bottom: 15px; margin-left: 10px; margin-top: 0px">
            <asp:ListItem>Cash</asp:ListItem>
            <asp:ListItem>Credit</asp:ListItem>
        </asp:DropDownList>
        <p>
            <asp:Button ID="btnRecharge" runat="server" Text="Recharge Balance" OnClick="btnRecharge_Click" Width="350px" style="margin-left: 12px"/>
        </p>
        <asp:Label ID="lblRechargeResult" runat="server" style="margin-left: 14px"></asp:Label>
    </form>
</body>
</html>
