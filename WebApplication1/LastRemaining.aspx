<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LastRemaining.aspx.cs" Inherits="TestwJazz.LastRemaining" %>
...
<body>
    <div class="container">
        <h1 class="page-title">Remaining Plan Amount</h1>
...
<div class="sidebar-line"></div>
        <div class="container">
            <div>
                ...
                <asp:Button ID="btnGetRemainingAmount" runat="server" Text="Get Remaining Amount" CssClass="button" OnClick="btnGetRemainingAmount_Click" />
                <br /><br />

                <asp:Label ID="lblRemainingAmount" runat="server" ForeColor="Green" Font-Bold="True" />
