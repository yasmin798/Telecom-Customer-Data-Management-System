<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VoucherRedeem.aspx.cs" Inherits="CustomerPart3.VoucherRedeem" %>
...
<div class="sidebar-line"></div>
        <div>
            <asp:Label ID="LabelMobileNoVoucher" runat="server" Text="Enter Mobile Number: " style="font-size: 30px; font-weight: bold; color: #007BFF; display: block; margin-bottom: 0px; padding: 5px; text-align: left; margin-left:6px"></asp:Label>
<asp:TextBox ID="txtMobileNoVoucher" runat="server" style="width: 500px; max-width: 300px; padding: 10px; font-size: 1rem; border-radius: 5px; border: 1px solid #ccc; margin-bottom: 15px; margin-left: 10px; margin-top: 0px"></asp:TextBox>
<br />

<asp:Label ID="LabelVoucherID" runat="server" Text="Enter Voucher ID: " style="font-size: 30px; font-weight: bold; color: #007BFF; display: block; margin-bottom: 0px; padding: 5px; text-align: left; margin-left:6px"></asp:Label>
<asp:TextBox ID="txtVoucherID" runat="server" style="width: 500px; max-width: 300px; padding: 10px; font-size: 1rem; border-radius: 5px; border: 1px solid #ccc; margin-bottom: 15px; margin-left: 10px; margin-top: 0px"></asp:TextBox>
<br />

<asp:Button ID="btnRedeemVoucher" runat="server" Text="Redeem Voucher" OnClick="btnRedeemVoucher_Click" Width="350px" style="margin-left: 12px" />
<br />

<asp:Label ID="lblVoucherResult" runat="server" Text="" style="margin-left: 14px"></asp:Label>
