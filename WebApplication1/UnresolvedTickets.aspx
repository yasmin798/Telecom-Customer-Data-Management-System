<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnresolvedTickets.aspx.cs" Inherits="TestwJazz.UnresolvedTickets" %>
...
<body>
    <div class="container">
        <h1 class="page-title">Unresolved Tickets</h1>
...
<div class="sidebar-line"></div>
        <div class="container">
            <div>
                ...
                <asp:TextBox ID="txtNationalID" runat="server" MaxLength="11" />
                <asp:Button ID="btnGetUnresolvedTickets" runat="server" Text="Get Unresolved Tickets" CssClass="button" OnClick="btnGetUnresolvedTickets_Click" />
                <br /><br />

                <!-- Styled Labels for unresolved tickets -->
                <div class="result-container">
                    <asp:Label ID="lblHeader" runat="server" CssClass="label" Text="Unresolved Tickets:" Visible="false" />
                    <asp:Label ID="lblUnresolvedCount" runat="server" CssClass="label-value" Visible="false" />
                </div>
