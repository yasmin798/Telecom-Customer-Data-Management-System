<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="transfer_amount.aspx.cs" Inherits="WebApplication1.transfer_amount" %>
...
<div class="sidebar-line"></div>
    ...
    Transfer Amount
        ...
        <div class="content-body">
            ...
            <br />
            <asp:Button ID="Button1" runat="server" Text="Search" onClick="DisplayAverageTransferAmount"/>
        </div>
    </div>
    </form>
</body>
