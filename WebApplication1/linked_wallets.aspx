<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="linked_wallets.aspx.cs" Inherits="WebApplication1.linked_wallets" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Linked Wallets</title>
...
<div class="sidebar-line"></div>
    ...
    Linked Wallets
        ...
        <div class="content-body">
            ...
            <br />
            <asp:Button ID="Button1" runat="server" Text="Search" OnClick="CheckWalletLink" />
        </div>
    </div>
    </form>
</body>
