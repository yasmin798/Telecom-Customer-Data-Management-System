...
{
    public partial class E_shops_vouchers : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                // SQL command to fetch data from the 'E_shopVouchers' view
                ...
                // Bind the data table to the GridView for displaying the E-shop and voucher details
                GridViewEshopVouchers.DataSource = dt;
